ESX.RegisterCommand({'setcoords', 'tp'}, { "dev", "superadmin", "admin"}, function(xPlayer, args)
...
if not Config.OxInventory then
	ESX.RegisterCommand('giveitem', { "dev", "superadmin", "admin"}, function(xPlayer, args)
...
ESX.RegisterCommand('info', { "dev", "superadmin", "admin", "user" }, function(xPlayer)
	local job = xPlayer.getJob().name
	print(('^2ID: ^5%s^0 | ^2Name: ^5%s^0 | ^2Group: ^5%s^0 | ^2Job: ^5%s^0'):format(xPlayer.source, xPlayer.getName(),
		xPlayer.getGroup(), job))
end, false)

ESX.RegisterCommand('coords', { "dev", "superadmin"}, function(xPlayer)
...
ESX.RegisterCommand('goto', { "dev", "superadmin", "admin", "mod"}, function(xPlayer, args)
...
ESX.RegisterCommand('bring', { "dev", "superadmin", "admin", "mod"}, function(xPlayer, args)
	local targetCoords = args.playerId.getCoords()
...
ESX.RegisterCommand('kill', { "dev", "superadmin", "admin", "mod"}, function(xPlayer, args)
...
ESX.RegisterCommand('freeze', { "dev", "superadmin", "admin", "mod"}, function(xPlayer, args)
...
ESX.RegisterCommand('unfreeze', { "dev", "superadmin", "admin", "mod"}, function(xPlayer, args)
