...
local loadPlayer = "SELECT `accounts`, `job`, `job_grade`, `faction`, `faction_grade`, `group`, `position`, `inventory`, `skin`, `loadout`, `metadata`"
...
function loadESXPlayer(identifier, playerId, isNew)
    ...
    -- Faction
    local faction, gradeF = result.faction, tostring(result.faction_grade)
    ...
    userData.job = {
        ...
        grade = tonumber(gradeF),
        grade_name = gradeFactionObject.name,
        grade_label = gradeFactionObject.label,
        grade_salary = gradeFactionObject.salary,

        skin_male = gradeFactionObject.skin_male and json.decode(gradeFactionObject.skin_male) or {},
        skin_female = gradeFactionObject.skin_female and json.decode(gradeFactionObject.skin_female) or {},
    }
  ...
  if result.group then
    ...
    -- xPlayer Creation
    local xPlayer = CreateExtendedPlayer(playerId, identifier, userData.group, userData.accounts, userData.inventory, userData.weight, userData.job, userData.faction, userData.loadout, GetPlayerName(playerId), userData.coords, userData.metadata)
